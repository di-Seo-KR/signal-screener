...
export const RISK_CONFIG = {
  ...
  // ★ 2026-05-12: 1.5 → 3.0 완화. 자본 $519 × 1.5 = $778 인데 단일 거래 minMarginUsd
  //   $100 × lev 10 = 노셔널 $1000 → 한 거래도 한도 초과로 모든 시그널 reject.
  //   3.0 으로 늘려 자본 $500 기준 거래 1~3개 동시 가능. 안전 측면은 합산 마진(60%) 가드가 별도.
  maxTotalNotionalRatio: 3.0,   // 자본 × 3.0 = 합산 노셔널 cap (이전 1.5)
