...
export const STRATEGY_PORTFOLIOS = {
  ...
  "₿ BTC 알파 전략": [
    { sym: "BTC-USD", w: 0.35 }, { sym: "ETH-USD", w: 0.15 }, { sym: "SOL-USD", w: 0.10 },
    { sym: "COIN", w: 0.08 }, { sym: "MSTR", w: 0.07 },
    { sym: "IBIT", w: 0.10 }, { sym: "ARKK", w: 0.05 },
    { sym: "SQ", w: 0.05 }, { sym: "PYPL", w: 0.05 },
  ],
  "BB 스퀴즈 돌파": [
  ...
  // ── 알파 전략 포트폴리오 (시장 비효율성 포착) ──
  "🧬 Hurst 레짐 스위칭": [
    { sym: "SPY", w: 0.08 }, { sym: "QQQ", w: 0.07 }, { sym: "NVDA", w: 0.06 },
    { sym: "TSLA", w: 0.06 }, { sym: "AAPL", w: 0.06 }, { sym: "MSFT", w: 0.06 },
    { sym: "AMD", w: 0.05 }, { sym: "META", w: 0.05 }, { sym: "AMZN", w: 0.05 },
    { sym: "BTC-USD", w: 0.07 }, { sym: "ETH-USD", w: 0.05 }, { sym: "SOL-USD", w: 0.04 },
    { sym: "GLD", w: 0.06 }, { sym: "JPM", w: 0.05 },
    { sym: "005930.KS", w: 0.05 }, { sym: "000660.KS", w: 0.04 },
    { sym: "IWM", w: 0.05 }, { sym: "XLE", w: 0.05 },
  ],
  "⚡ 변동성 군집 돌파": [
    { sym: "TSLA", w: 0.07 }, { sym: "NVDA", w: 0.07 }, { sym: "AMD", w: 0.06 },
    { sym: "BTC-USD", w: 0.07 }, { sym: "SOL-USD", w: 0.05 }, { sym: "ETH-USD", w: 0.05 },
    { sym: "AVGO", w: 0.05 }, { sym: "COIN", w: 0.04 }, { sym: "MSTR", w: 0.04 },
    { sym: "005930.KS", w: 0.05 }, { sym: "042700.KS", w: 0.04 },
    { sym: "META", w: 0.05 }, { sym: "NFLX", w: 0.04 },
    { sym: "BA", w: 0.04 }, { sym: "XOM", w: 0.04 },
    { sym: "SPY", w: 0.06 }, { sym: "GLD", w: 0.05 },
    { sym: "ARKK", w: 0.04 }, { sym: "SOXX", w: 0.05 },
  ],
  "📐 효율성 비율 전략": [
    { sym: "NVDA", w: 0.07 }, { sym: "TSLA", w: 0.06 }, { sym: "AAPL", w: 0.06 },
    { sym: "MSFT", w: 0.06 }, { sym: "AMD", w: 0.05 }, { sym: "AVGO", w: 0.05 },
    { sym: "BTC-USD", w: 0.07 }, { sym: "ETH-USD", w: 0.05 }, { sym: "SOL-USD", w: 0.04 },
    { sym: "AMZN", w: 0.05 }, { sym: "META", w: 0.05 }, { sym: "GOOG", w: 0.05 },
    { sym: "005930.KS", w: 0.05 }, { sym: "000660.KS", w: 0.04 },
    { sym: "SPY", w: 0.06 }, { sym: "QQQ", w: 0.05 },
    { sym: "JPM", w: 0.04 }, { sym: "GS", w: 0.04 },
    { sym: "XLK", w: 0.04 },
  ],
  "📉 모멘텀 감쇠 포착": [
    { sym: "TSLA", w: 0.07 }, { sym: "NVDA", w: 0.06 }, { sym: "AMD", w: 0.06 },
    { sym: "BTC-USD", w: 0.07 }, { sym: "SOL-USD", w: 0.05 }, { sym: "ETH-USD", w: 0.05 },
    { sym: "META", w: 0.05 }, { sym: "NFLX", w: 0.05 }, { sym: "COIN", w: 0.04 },
    { sym: "005930.KS", w: 0.05 }, { sym: "035720.KS", w: 0.04 },
    { sym: "SHOP", w: 0.04 }, { sym: "SQ", w: 0.04 },
    { sym: "CRWD", w: 0.04 }, { sym: "DDOG", w: 0.04 },
    { sym: "SPY", w: 0.06 }, { sym: "IWM", w: 0.05 },
    { sym: "ARKK", w: 0.04 }, { sym: "XLF", w: 0.05 },
  ],
  "🔮 정보흐름 감지": [
    { sym: "AAPL", w: 0.07 }, { sym: "MSFT", w: 0.06 }, { sym: "NVDA", w: 0.06 },
    { sym: "TSLA", w: 0.06 }, { sym: "AMZN", w: 0.05 }, { sym: "META", w: 0.05 },
    { sym: "BTC-USD", w: 0.07 }, { sym: "ETH-USD", w: 0.05 }, { sym: "SOL-USD", w: 0.04 },
    { sym: "005930.KS", w: 0.05 }, { sym: "000660.KS", w: 0.04 },
    { sym: "JPM", w: 0.05 }, { sym: "GS", w: 0.04 }, { sym: "BAC", w: 0.04 },
    { sym: "SPY", w: 0.06 }, { sym: "QQQ", w: 0.05 },
    { sym: "GLD", w: 0.04 }, { sym: "XOM", w: 0.04 },
    { sym: "COIN", w: 0.04 },
  ],
};
      ...
      <div className="tab-content">
        ...
        <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: "16px", padding: "20px", marginBottom: "12px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "8px" }}>
            <span style={{ padding: "4px 10px", borderRadius: "6px", fontSize: "14px", fontWeight: 700,
          ...
          <div style={{ fontSize: "14px", color: C.green, marginBottom: "12px", display: "flex", alignItems: "center", gap: "6px" }}>
            ...
            <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: "16px", padding: "20px", marginBottom: "12px" }}>
              ...
              <div style={{ maxHeight: "200px", overflow: "auto" }}>
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1px", background: C.border, borderRadius: "8px", overflow: "hidden" }}>
                  {["날짜", "일간", "누적"].map(h => (
                    <div key={h} style={{ background: C.card2, padding: "6px 8px", fontSize: "14px", fontWeight: 700, color: C.text3, textAlign: "center" }}>{h}</div>
                  ))}
                  {[...s.returns].reverse().slice(0, 30).map((r, i) => (
                    <React.Fragment key={i}>
                      <div style={{ background: C.card, padding: "5px 8px", fontSize: "14px", color: C.text2, textAlign: "center" }}>{r.date.slice(5)}</div>
                      <div style={{ background: C.card, padding: "5px 8px", fontSize: "14px", fontWeight: 700, textAlign: "center",
                  ...
                  return (
                    <div key={i} style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 10px",
                      ...
                      <div style={{ width: "28px", height: "28px", borderRadius: "6px",
                        ...
                        fontSize: "12px", fontWeight: 800, color: `hsl(${(i * 23) % 360}, 65%, 65%)`, flexShrink: 0 }}>
  ...
  return (
    <div className="tab-content">
      <div style={{ background: `linear-gradient(135deg, ${C.card} 0%, ${C.card2} 100%)`, border: `1px solid ${C.border}`,
        ...
        <div style={{ color: C.text3, fontSize: "15px", marginBottom: "4px" }}>
          {strategyData.length}개 전략 · 실시간 Yahoo Finance 데이터 · 전략 generate() 백테스트
        </div>
        {lastUpdate && <div style={{ color: C.text3, fontSize: "14px", marginBottom: "16px" }}>마지막 업데이트: {lastUpdate.toLocaleString("ko-KR")}</div>}
        <div style={{ display: "flex", gap: "8px", overflowX: "auto", paddingBottom: "4px" }}>
          {topPerformers.map((s, i) => (
            ...
            onMouseLeave={e => e.currentTarget.style.borderColor = C.border2}>
              <div style={{ fontSize: "14px", color: C.yellow, marginBottom: "2px", fontWeight: 700 }}>#{i + 1}</div>
              <div style={{ fontWeight: 700, fontSize: "15px", marginBottom: "6px", whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis" }}>{s.name}</div>
          ...
          onMouseLeave={e => e.currentTarget.style.borderColor = C.border}>
            ...
            <div style={{ display: "flex", gap: "3px", flexWrap: "wrap" }}>
              {s.portfolio.slice(0, 5).map((p, j) => (
                <span key={j} style={{ padding: "1px 5px", borderRadius: "4px", fontSize: "12px",
                  background: C.card2, color: C.text3 }}>{getName(p.sym)}</span>
              ))}
              {s.portfolio.length > 5 && (
                <span style={{ padding: "1px 5px", borderRadius: "4px", fontSize: "12px",
